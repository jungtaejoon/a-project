  ...
  <div class="nav_profile">
    <div class="media profile-left">
      <a class="float-left profile-thumb" href="javascript:void(0)">
        <img :src="this.$store.getters.user.picture" class="rounded-circle" alt="User Image">
      </a>
      <div class="content-profile">
        <h4 class="media-heading user_name_max" v-text="this.$store.getters.user.name"></h4>
        <ul class="icon-list">
          <li>
